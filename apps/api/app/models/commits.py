...
class Commit(Base):
    ...
    # Changes
    files_changed: Mapped[Optional[list]] = mapped_column(JSON, nullable=True)  # Array of file paths
    stats: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)  # {"additions": N, "deletions": N, "total": N}
